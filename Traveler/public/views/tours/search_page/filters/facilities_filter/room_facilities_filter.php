...
<div class="facilities-filter filter">
    <h3 class="filter-header">Зручності в кімнаті</h3>
    <div class="filter-body facilities-select" id="room-facilities">
        <?php foreach ($roomFacilities as $i => $facility) : ?>
            <label for="tour-facility-<?= $i ?>" data-facility-id="<?= $facility['facility_id'] ?>" class="check">
                ...
                <input id="tour-facility-<?= $i ?>" type="checkbox" style="display: none"/>
            </label>
        <?php endforeach; ?>
    </div>
