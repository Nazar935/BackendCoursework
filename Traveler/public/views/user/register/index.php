...
<head>
    ...
    <style>
        ...
        <?php include 'views/user/login/login_style.css'?>
...
<div class="scroll-bar">
    <main class="login">
        <img src="/files/static/register.webp" alt="login"/>
            ...
            <form method="POST" action="">
                ...
                <?php if (isset($error)) :?>
                    ...
                    <div class="input-wrapper icon-input password">
                        <input placeholder="Пароль" name="password" value="<?= $model['password'] ?>" type="password" autocomplete="off">
                        <i class="material-icons">password</i>
                    </div>
                    <div class="input-wrapper icon-input password">
                        <input placeholder="Повторіть пароль" name="password2" value="<?= $model['password2'] ?>" type="password" autocomplete="off">
                        <i class="material-icons">password</i>
                    </div>
                    <div class="error-wrapper" id="form-error">
                        <div class="error">
                            <i>
                        ...
                        <div class="button-wrapper">
                            <button type="button" id="remove-error">
                ...
                <?php else: ?>
                    ...
                    <div class="input-wrapper icon-input password">
                        <input placeholder="Повторіть пароль" name="password2" type="password" autocomplete="off">
                        <i class="material-icons">password</i>
                    </div>
                <?php endif; ?>
                ...
                <button class="btn-4">Зареєструватися</button>
            </form>
        </div>
    </main>
...
<script>
    ...
    <?php include 'views/user/login/login_script.js' ?>
    <?php include 'register_script.js' ?>
</script>
</body>
</html>